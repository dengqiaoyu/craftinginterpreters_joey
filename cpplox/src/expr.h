...
template <typename R>
std::ostream&
operator<<(std::ostream& out_s, const Expr<R>& expr)
{
...
template <typename R>
R
Binary<R>::accept(const Visitor<R>& visitor) const
{
...
template <typename R>
R
Grouping<R>::accept(const Visitor<R>& visitor) const
{
...
template <typename R>
R
Literal<R>::accept(const Visitor<R>& visitor) const
{
...
template <typename R>
R
Unary<R>::accept(const Visitor<R>& visitor) const
{
